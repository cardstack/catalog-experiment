...
```
catalogjs . ../test-lib ../recipes ../../cdn/pkgs
```
where `../test-lib`, `../recipes`, and `../../cdn/pkgs` are directories that you want to make available to the CatalogJS build environment.
